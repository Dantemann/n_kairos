...
@Injectable()
export class MessagingSmsCredentialsService implements CredentialAbstractService<CredentialsAbstractDocument> {
    constructor(
    ...
    async createCredentials(body: CreateCredentialsDto): Promise<CredentialsAbstractDocument> {
        ...
        let service: CredentialAbstractService = this.__smsChannelServices?.[validMessagingDto.channel]??null;
